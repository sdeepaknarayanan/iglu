...
alpha = tf.get_variable(name="Alpha", shape=[2708,64], dtype=tf.float32, initializer=tf.zeros_initializer(), trainable=False)
X1_var = tf.get_variable(name="X1", shape=[2708,64], dtype=tf.float32, initializer=tf.zeros_initializer(), trainable=False)
